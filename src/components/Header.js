      ...
      <header className={headerClass}>
        ...
        <nav className={`mobile-menu ${isMenuOpen ? 'active' : ''}`}>
          ...
          <ul className="menu">
            ...
            <li className="menu-item-has-children">
              <a  style={{ cursor: 'pointer' }} onClick={(e) => { e.preventDefault(); toggleSubMenu('about'); }}>About</a>
            ...
            <li className="menu-item-has-children">
              <a  style={{ cursor: 'pointer' }} onClick={(e) => { e.preventDefault(); toggleSubMenu('Solutions'); }}>Solutions</a>
